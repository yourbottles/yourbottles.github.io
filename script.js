...
const EMAILJS_CONFIG = {
    SERVICE_ID: "Yourbottlesapp",
    TEMPLATE_ID: "template_xtkxr3h",
    PUBLIC_KEY: "WwjEVbDtQjkRZqBWq",
    YOUR_EMAIL: "yourbottlesindia@gmail.com"
};
...
async function sendNotification(userData, theme) {
    ...
    try {
        const templateParams = {
            ...
            business_name: "Yourbottles Labels Inquiry",
...
function saveLocalNotification(userData, theme) {
    ...
    const savedNotifications = JSON.parse(localStorage.getItem('yourbottles_notifications') || '[]');
    savedNotifications.push(notification);
    localStorage.setItem('yourbottles_notifications', JSON.stringify(savedNotifications));
...
function loadUserData() {
    const savedData = localStorage.getItem('yourbottles_user');
    if (savedData) {
        try {
            ...
            localStorage.removeItem('yourbottles_user');
        }
    }
}
...
function saveUserData(userData) {
    ...
    localStorage.setItem('yourbottles_user', JSON.stringify(dataToSave));
...
console.log(`
%c===================================================
       YOURBOTTLES - CUSTOM LABELS PRODUCER
===================================================
📍 Location: Dubey Colony Padawa, Khandwa MP India
📧 Email: yourbottlesindia@gmail.com
📞 Phone: +91 6261491292
